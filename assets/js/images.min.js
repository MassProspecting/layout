imagesJs = {
	...
	next_screenshot: function() {
		...
		let q = $('.screenshot[data-number="' + next_number + '"]')
		let src = $(q).attr('src');
		$(img).attr('src', src);
		$(img).attr('data-number', next_number);
		// update the number
		imagesJs.update_numbers();
	},
	...
	prev_screenshot: function() {
		...
		// get the src of the next image
		let q = $('.screenshot[data-number="' + prev_number + '"]');
		let src = $(q).attr('src');
		$(img).attr('src', src);
        ...
        if ($('div.screenshot-modal').length === 0) {
            ...
            const modalHTML = `
                <div id="screenshot_modal" class="screenshot-modal" tabindex="-1">
                    ...
                    <img src="" id="screenshot_modal_img" data-number="" />
